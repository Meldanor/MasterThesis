...
\todo{Graphen zeichnen und die verschiedenen typen aufzeichnen}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\textwidth]{uml_diagram_selectionPhaseSCIONLab.pdf}
	\caption{Communication diagram - Selection phase}
	\label{fig:main:impl:selectionPhaseDiagram}
\end{figure}
