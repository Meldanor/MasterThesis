...
The following list show possible attributes of a greedy user:
\begin{easylist}
    # Use much more bandwidth than other user
    # Higher activity and online time than other user
\end{easylist}
...
\todo{What is the difference between a greedy and a normal user?}
